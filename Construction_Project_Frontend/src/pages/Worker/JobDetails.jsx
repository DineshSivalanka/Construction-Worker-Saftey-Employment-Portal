        ...
        <div className="rounded-2xl bg-white p-8 shadow-sm">
          ...
          <div className="mb-6 grid gap-4 md:grid-cols-2">
            ...
            <div className="rounded-lg bg-slate-50 p-4">
              ...
              <p className="text-lg font-semibold text-orange-600">₹900/day</p>
            </div>
            <div className="rounded-lg bg-slate-50 p-4">
          ...
          <button className="w-full rounded-lg bg-green-600 px-4 py-3 font-semibold text-white hover:bg-green-700">Apply Now</button>
        </div>
      </main>
      <Footer />
    </div>
